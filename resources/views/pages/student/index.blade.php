    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Tambah Data Mahasiswa</h5>
...
@push('scripts')
    ...
    <script>
        ...
        function resetForm() {
            ...
            $('#myModalLabel').text('Tambah Data Mahasiswa');
        ...
        function loadDataTable() {
            ...
            dataTable = new AppDataTable({
                ...
                options: {
                    ...
                    searchPlaceholder: 'Cari NIM, Nama, Fakultas, Jurusan atau Tahun Masuk...'
                }
            });
        ...
        function editData(encryptedId) {
            var urlEdit = '{{ url('student/edit') }}/' + encryptedId;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        $('#nama_mahasiswa').val(response.data.nama_mahasiswa);
                        $('#fakultas').val(response.data.fakultas);
                        $('#jurusan').val(response.data.jurusan);
                        $('#tahun_masuk').val(response.data.tahun_masuk);
                        ...
                        $('#myModalLabel').text('Edit Data Mahasiswa');
                        $('#btnave').text('Update Data');
        ...
        function deleteData(encryptedId) {
            ...
            Swal.fire({
                ...
                html: item ?
                    `Anda akan menghapus data mahasiswa:<br><strong>${item.name}</strong> (${item.nim})` :
                ...
                if (result.isConfirmed) {
                    ...
                    // Delete via AJAX
                    $.ajax({
                        url: '{{ url('/student/clear/') }}/' + encryptedId,
                        method: 'DELETE',
                        headers: {
